...
<body>
  ...
  <div class="container py-4">
    ...
    <div>
      ...
      <label> <b>Polling</b></label>
    </div>

    <header class="container py-4">
      <h2 class="text-danger">Polling</h2>
    </header>
    <!-- section-header.// -->

    <section class="polling-sec">
      <div class="container">

        <hr>
        <div id="fr-kualitas">
          <h4>Bagaimana Kualiatas Informasi Di Portal Padang.go.id ?</h4>
          <label class="form-text text-muted">Pilih Salah Satu!</label>
          <div class="form-check pt-3">
            <input class="form-check-input" type="radio" name="rbkualitas" id="rbkualitas1" value="option1">
            <label class="form-check-label" for="rbkualitas1">
              Sangat Puas
            </label>
          </div>
          <div class="form-check pt-3">
            <input class="form-check-input" type="radio" name="rbkualitas" id="rbkualitas2" value="option2">
            <label class="form-check-label" for="rbkualitas2">
              Baik
            </label>
          </div>
          <div class="form-check pt-3 pb-3">
            <input class="form-check-input" type="radio" name="rbkualitas" id="rbkualitas3" value="option3">
            <label class="form-check-label" for="rbkualitas3">
              Perlu Ditingkatkan
            </label>
          </div>
          <button type="submit" class="btn btn-primary" onclick="sendKualitas()">Berikan Respon</button>
        </div>
        <div id="fr-kualitas-suc">
          <h4>Terkirim !</h4>
          <button type="submit" class="btn btn-primary" onclick="sendKualitas()">Respon Kembali</button>
        </div>

        <hr>
        <div id="fr-publikasi">
          <h4>Jenis Publikasi Yang Disukai Atau Dibutuhkan ?</h4>
          <label class="form-text text-muted">Pilih Salah Satu!</label>
          <div class="form-check pt-3">
            <input class="form-check-input" type="radio" name="rbPublikasi" id="rbPublikasi1" value="option1">
            <label class="form-check-label" for="rbPublikasi1">
              Sangat Puas
            </label>
          </div>
          <div class="form-check pt-3">
            <input class="form-check-input" type="radio" name="rbPublikasi" id="rbPublikasi2" value="option2">
            <label class="form-check-label" for="rbPublikasi2">
              Baik
            </label>
          </div>
          <div class="form-check pt-3 pb-3">
            <input class="form-check-input" type="radio" name="rbPublikasi" id="rbPublikasi3" value="option3">
            <label class="form-check-label" for="rbPublikasi3">
              Perlu Ditingkatkan
            </label>
          </div>
          <button type="submit" class="btn btn-primary" onclick="sendPublikasi()">Berikan Respon</button>
        </div>
        <div id="fr-publikasi-suc">
          <h4>Terkirim !</h4>
          <button type="submit" class="btn btn-primary" onclick="sendPublikasi()">Respon Kembali</button>
        </div>
