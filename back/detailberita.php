...
$id = $_GET['id'];
$dberita = mysqli_query($db, "SELECT * FROM berita b JOIN kategori k ON b.id_kategori = k.id_kategori JOIN penulis p ON b.id_penulis = p.id_penulis where id_berita='$id';");
$berita = mysqli_fetch_array($dberita);
  ...
  <div style="background-color: #f2f2f2;">
    <div class="container py-4">
      ...
      <div>
        ...
        <a href="media.php" class="text-muted">Media Berita</a>
        <label class="ml-2 mr-2">/</label>
        <label> <b>Detail Berita</b></label>
      </div>
          ...
          <div class="row">
            <div class="mx-auto pt-4">
              <div class="alert alert-secondary" role="alert">
                <span class="iconify" data-icon="octicon:paperclip-24" style="color: black; font-size: 24px;"></span> <?= $berita['nama_kategori']; ?>
              </div>
            </div>
          </div>
          <div class="container">
            <h5 class="card-title text-center" style="padding-top:32px;"> <b><?= $berita['judul_berita']; ?></b> </h5>
          </div>
          <div class="container">
            <div class="card-body">
              ...
              <table class="col-12 text-center">
                ...
                <tr>
                  <td class="col-4"> <b> <?= $berita['nama_kategori']; ?></b></td>
                  <td class="col-4"> <b><?= $tanggal ?></b></td>
                  <td class="col-4"> <b><?= $berita['nama_penulis']; ?></b></td>
                </tr>
              </table>

              <div class="mx-auto my-4">
                <div class="col-12 text-center">
                  <!-- <img src="backend/foto/<?= $berita['gambar']; ?>" alt="" class="rounded img-fluid"> -->


                  <div class="embed-responsive embed-responsive-16by9">
                    <img class="embed-responsive-item rounded" src="backend/foto/<?= $berita['gambar']; ?>" alt="" class="rounded" style="object-fit: cover;">
                  </div>

                </div>
              </div>

              <div class="text-justify mx-2 my-3 col-md-10 mx-auto">
                <?= $berita['isi_berita']; ?>
              </div>
